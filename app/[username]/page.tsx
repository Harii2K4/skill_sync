...
import { MyGigsList } from "./components/my-gigs-list";
...
const SellerPage = ({
    ...
    const skills = useQuery(api.skills, { username: params.username });
    ...
    const skillsString = skills ? skills.map((skill: { skill: any; }) => skill.skill).join(", ") : "";
